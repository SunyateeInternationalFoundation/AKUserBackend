...
const childrenSchema = new mongoose.Schema(
  {
    ...
    extraDetails: {
      medicalInfo: {
        ...
        primaryHealthcareProviderName: { type: String, required: false },
        primaryHealthcareProviderContact: { type: String, required: false },
      },
      behavioralInfo: {
        ...
        calmingStrategies: { type: String, required: false },
        meltdownTriggers: { type: String, required: false },
        repetitiveBehaviors: { type: String, required: false },
      },
      therapyHistory: {
        ...
        challengesObserved: { type: String, required: false },
        goalsAchieved: { type: String, required: false },
        strengthsAndInterests: { type: String, required: false },
      },
      admissionGoal: {
